...
@interface MyTourResultsViewController ()

@end

@implementation MyTourResultsViewController
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if([segue.identifier isEqualToString:@"detail"]){
        MyTourDetailViewController *vc = [segue destinationViewController];
